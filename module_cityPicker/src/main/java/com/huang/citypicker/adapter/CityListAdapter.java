...
import com.huang.citypicker.R;
import com.huang.citypicker.adapter.decoration.GridItemDecoration;
...
public class CityListAdapter extends RecyclerView.Adapter<CityListAdapter.BaseViewHolder> {
    ...
    private List<City> mHotData;
    private final List<City> mLocateData;
    private int locateState;
    private InnerListener mInnerListener;

    public CityListAdapter(Context context, List<City> data, List<City> hotData, List<City> locateData, int state) {
        this.mData = data;
...
//            });
            ...
            final City data = mData.get(pos);
            if (data == null) return;
            GridListAdapter mAdapter = new GridListAdapter(mContext, mLocateData);
    ...
    public int getItemViewType(int position) {
        if (position == 0 && TextUtils.equals("常", mData.get(position).getSection().substring(0, 1)))
