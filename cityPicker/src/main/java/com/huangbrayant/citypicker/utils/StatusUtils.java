package com.huangbrayant.citypicker.utils;
...
public class StatusUtils {
    ...
    public static void setStatusBar(Window window, boolean useThemestatusBarColor, boolean withoutUseStatusBarColor) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (useThemestatusBarColor) {
                window.setStatusBarColor(ContextCompat.getColor(window.getContext(), R.color.cp_colorAccent));
            } else {
    ...
    public static void setStatusTextColor(boolean useDart, Window window) {
        if (isFlyme()) {
            ...
            window.getDecorView().findViewById(android.R.id.content).setPadding(0, 0, 0, StatusUtils.navigationHeight);
        }
    }
}
