package com.huangbrayant.citypicker.view;
...
public class XEditText extends EditText {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attributeSet, R.styleable.XEditText);

        switch (typedArray.getInteger(R.styleable.XEditText_clearButtonMode, 0)) {
            case 1:
        ...
        int clearButton = typedArray.getResourceId(R.styleable.XEditText_clearButtonDrawable, R.mipmap.cp_icon_clear_all);
        typedArray.recycle();
