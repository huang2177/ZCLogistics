...
import com.huang.citypicker.CityPicker;
...
import com.huang.citypicker.model.LocateState;
...
import com.module.base.listener.LoadMoreListener;
import com.module.base.utils.ToastUtil;
import com.module.base.widgets.XPopupWindow;
...
public class SourceFragment extends BaseFragment implements LoadMoreListener.Listener
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.rl_car_model) {
            selectCarInfo();

        } else if (i == R.id.rl_car_length) {
            selectCarLength();

        } else if (i == R.id.tv_route_start) {
            chooseRouteStart();

        } else if (i == R.id.tv_route_end) {
            chooseRouteEnd();
