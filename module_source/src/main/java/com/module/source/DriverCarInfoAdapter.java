...
public class DriverCarInfoAdapter extends RecyclerView.Adapter {

    private Context activity;
    private SparseArray<ViewHolder> array;

    public DriverCarInfoAdapter(Context activity) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int position) {
        ...
        View view = LayoutInflater.from(activity).inflate(R.layout.item_driver_car, parent, false);
